...
#include "SegmentationSymbolReadOperator.h"
...
void SegmentationSymbolReadOperator::collect(MCGAL::Halfedge* seed,
                                             char* buffer,
                                             int& dataOffset,
...
void SegmentationSymbolReadOperator::collect(std::vector<MCGAL::Halfedge*> seeds,
                                             char* buffer,
                                             int& dataOffset,
                                             std::vector<MCGAL::Vertex*>& vertices,
                                             std::vector<MCGAL::Halfedge*>& halfedge,
