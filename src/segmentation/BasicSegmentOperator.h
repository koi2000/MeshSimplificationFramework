 ...
 * @Description:
 */
#ifndef BASCI_SEGMENT_OPERATOR_H
#define BASCI_SEGMENT_OPERATOR_H
 ...
 * 第二种就是由压缩算法来指定分区数量
 */
class BasicSegmentOperator : public SegmentOperator {
  public:
    BasicSegmentOperator(int number) : number(number) {}
    ~BasicSegmentOperator() = default;
