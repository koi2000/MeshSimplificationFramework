#ifndef EDGE_COLLAPSE_PRIORITY_ERROR_ENCODER_H
#define EDGE_COLLAPSE_PRIORITY_ERROR_ENCODER_H
...
class EdgeCollapsePriorityErrorEncoder {
  public:
    EdgeCollapsePriorityErrorEncoder() {};
